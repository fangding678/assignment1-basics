...
from cs336_basics.transformer import TransformerBlock, TransformerLM, CrossEntropyLoss
from cs336_basics.train import AdamW, get_lr_cosine_schedule, gradient_clipping, get_batch_data
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    multi_head_self_attention = MultiHeadSelfAttentionRope(d_model, num_heads, max_seq_len, theta, q_proj_weight,
...
def get_tokenizer(
    ...
    """
    bpe_tokenizer = BpeTokenizer('', 0, special_tokens, vocab, merges)
